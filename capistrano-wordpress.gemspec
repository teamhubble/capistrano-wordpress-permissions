...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Wordpress integration for Capistrano.}
  spec.description   = %q{Wordpress integration for Capistrano.}
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/teamhubble/capistrano-wordpress'
  else
